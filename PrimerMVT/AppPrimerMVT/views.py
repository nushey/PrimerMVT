...
def mi_familia(request):
    ...
    fecha_nacimiento1=datetime.datetime(1981, 2, 6)
    fecha_nacimiento2=datetime.datetime(1985, 4, 18)
    fecha_nacimiento3=datetime.datetime(2007, 5, 15)
    familiar_1 = Familiares(nombre="Fernando Zeballos", parentesco="padre", edad="41",fecha_nacimiento=datetime.datetime.strftime(fecha_nacimiento1, "%d/%m/%Y"))
